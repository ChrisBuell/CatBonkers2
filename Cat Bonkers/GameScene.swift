...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    //var ladybug = SKSpriteNode(imageNamed: "BlueLadybug1.png")
   
    
    //ladybug action variables
    ...
    override func didMove(to view: SKView) {
        ...
        if UIDevice.current.userInterfaceIdiom == .phone {
            ...
            let walkFrames:[SKTexture] = [
                ...
                textureAtlas.textureNamed("PhoneBLB2.png"),
                textureAtlas.textureNamed("PhoneBLB3.png"),
                textureAtlas.textureNamed("PhoneBLB2.png"),
                textureAtlas.textureNamed("PhoneBLB4.png"),
                textureAtlas.textureNamed("PhoneBLB5.png"),
                textureAtlas.textureNamed("PhoneBLB4.png")
    ...
    func spawnLadybug(){
        let ladybug = SKSpriteNode(imageNamed: "PhoneBLB1.png")
        ...
        let angle = atan2(newExitPos.y - newStartPos.y, newExitPos.x - newStartPos.x) - CGFloat(Double.pi / 2)
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        if bugTouched != true {} else {
            ...
            let angle = atan2(newExitPos.y - currentPos.y, newExitPos.x - currentPos.x) - CGFloat(Double.pi / 2)
